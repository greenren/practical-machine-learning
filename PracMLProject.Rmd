...
As the confusion matrix above shows, the out-of-bag (oob) error rate is estimated to be 0.65%, which is very low and a good sign.

Although the random forest algorithm already does cross-validation in the process (which results in the oob error rate estimate), it cannot hurt, however, to estimate the out of sample error with our own cross-validation:
